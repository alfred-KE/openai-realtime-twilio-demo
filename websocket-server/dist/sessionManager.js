...
function handleTwilioMessage(data) {
    ...
    switch (msg.event) {
        case "start":
            console.log("Twilio stream started, streamSid:", (_a = msg.start) === null || _a === void 0 ? void 0 : _a.streamSid);
...
function tryConnectModel() {
    ...
    session.modelConn.on("open", () => {
        ...
        const functionSchemas = functionHandlers_1.default.map((f) => f.schema);
        jsonSend(session.modelConn, {
            type: "session.update",
            session: Object.assign({ modalities: ["text", "audio"], turn_detection: {
                ...
                }, voice: "ash", input_audio_transcription: { model: "gpt-4o-mini-transcribe" }, input_audio_format: "g711_ulaw", output_audio_format: "g711_ulaw", tools: functionSchemas.length > 0 ? functionSchemas : undefined }, config),
        });
...
function handleModelMessage(data) {
    ...
    switch (event.type) {
        ...
        case "response.output_item.added":
            console.log("Response output item added:", (_a = event.item) === null || _a === void 0 ? void 0 : _a.type);
            break;
        ...
        case "conversation.item.input_audio_transcription.failed":
            ...
            break;
        case "response.done":
            if (((_b = event.response) === null || _b === void 0 ? void 0 : _b.status) === "failed") {
                ...
                console.log("Response completed successfully:", (_c = event.response) === null || _c === void 0 ? void 0 : _c.status);
            }
            break;
        case "error":
